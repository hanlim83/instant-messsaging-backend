module github.com/hanlim83/instant-messsaging-backend/http-server

go 1.18

require (
	github.com/TikTokTechImmersion/assignment_demo_2023/http-server v0.0.0-20230518060359-4b2e6777fae0
